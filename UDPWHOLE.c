...
int UDPClient(char ip[], char name[], char pnum[]) {
...
char ppc[10] = "1", pnum[10] = "33333", sib[10] = "12", pi[10] = "1.0", ip[20];
int np = 0, serv = 0;
int opt;
    ...
    else
    {
        pthread_t sender;
        pthread_t reciever;
        pthread_create(&child, NULL, &UDPClient(char ip[], char name[], char pnum[]), NULL);
        printf("\n\nRunning in client mode\n");
        UDPClient(ip,"hello!", pnum );
    }
